...
mod tests {
    ...
    pub fn decode<T: Decode>(
        decoder: &mut rasn::ber::de::Decoder,
    ) -> Result<T, rasn::ber::de::Error> {
        T::decode(decoder)
    }
    ...
    fn get_response_var_bind_array() {
            ...
            data: GetResponse(Pdu {
                ...
                variable_bindings: vec![
                    VarBind {
                        ...
                        value: ObjectSyntax::Simple(SimpleSyntax::String("Linux nmsworker-devel 2.6.18-164.el5 #1 SMP Thu Sep 3 03:28:30 EDT 2009 x86_64".into())),
                    },
                    VarBind {
                        name: ObjectIdentifier::new_unchecked(
                            vec![1, 3, 6, 1, 2, 1, 1, 2, 0].into(),
                        ),
        ...
        let expected_data = [
            ,
        ];
